    ...
    <section>
      ...
      >
        <textarea
          ...
          rows={3}
          required
          className="pl-4 pr-32 py-2 mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full border-neutral-300 rounded-md bg-neutral-800 text-neutral-100"
        />
        <button
          className="flex items-center justify-center absolute right-2 top-2 px-2 py-1 font-medium h-7 bg-neutral-700 text-neutral-100 rounded w-16"
          type="submit"
        >
          Enviar
        </button>
